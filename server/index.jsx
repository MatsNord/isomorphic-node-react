...
// The following imports are dependencies for server rendering
...
app.get(['/', '/questions/:id'], function* (req, res) {
  ...
  // This is where the server part of server render takes place
  const initialState = {
    questions: []
  }
  ...
  if (useServerRender) {
    ...
    index = index.replace(`<%= preloadApplication %>`, `Please wait while we load the application.`)
  }
